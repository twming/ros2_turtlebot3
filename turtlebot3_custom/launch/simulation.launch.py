...
def generate_launch_description():
    ...
    ign_resource_path = SetEnvironmentVariable(
        ...
        ":" +
        os.path.join(get_package_share_directory('turtlebot3_custom'), "models")])
    ...
    world_only = os.path.join(get_package_share_directory('turtlebot3_custom'), "models", "worlds", "world_only.sdf")
